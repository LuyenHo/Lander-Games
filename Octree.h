...
public:
    ...
    bool intersect(const Box &, TreeNode & node, vector<Box> & boxListRtn, vector<int> & pointsList);
    ...
    ofColor color[7] = {ofColor(ofColor::red), ofColor(ofColor::orange), ofColor(ofColor::yellow), ofColor(ofColor::green), ofColor(ofColor::blue), ofColor(ofColor::aliceBlue), ofColor(ofColor::purple)};
